...
import (
	...
	"github.com/arenadata/consul/command/acl"
	aclagent "github.com/arenadata/consul/command/acl/agenttokens"
	aclam "github.com/arenadata/consul/command/acl/authmethod"
	aclamcreate "github.com/arenadata/consul/command/acl/authmethod/create"
	aclamdelete "github.com/arenadata/consul/command/acl/authmethod/delete"
	aclamlist "github.com/arenadata/consul/command/acl/authmethod/list"
	aclamread "github.com/arenadata/consul/command/acl/authmethod/read"
	aclamupdate "github.com/arenadata/consul/command/acl/authmethod/update"
	aclbr "github.com/arenadata/consul/command/acl/bindingrule"
	aclbrcreate "github.com/arenadata/consul/command/acl/bindingrule/create"
	aclbrdelete "github.com/arenadata/consul/command/acl/bindingrule/delete"
	aclbrlist "github.com/arenadata/consul/command/acl/bindingrule/list"
	aclbrread "github.com/arenadata/consul/command/acl/bindingrule/read"
	aclbrupdate "github.com/arenadata/consul/command/acl/bindingrule/update"
	aclbootstrap "github.com/arenadata/consul/command/acl/bootstrap"
	aclpolicy "github.com/arenadata/consul/command/acl/policy"
	aclpcreate "github.com/arenadata/consul/command/acl/policy/create"
	aclpdelete "github.com/arenadata/consul/command/acl/policy/delete"
	aclplist "github.com/arenadata/consul/command/acl/policy/list"
	aclpread "github.com/arenadata/consul/command/acl/policy/read"
	aclpupdate "github.com/arenadata/consul/command/acl/policy/update"
	aclrole "github.com/arenadata/consul/command/acl/role"
	aclrcreate "github.com/arenadata/consul/command/acl/role/create"
	aclrdelete "github.com/arenadata/consul/command/acl/role/delete"
	aclrlist "github.com/arenadata/consul/command/acl/role/list"
	aclrread "github.com/arenadata/consul/command/acl/role/read"
	aclrupdate "github.com/arenadata/consul/command/acl/role/update"
	acltoken "github.com/arenadata/consul/command/acl/token"
	acltclone "github.com/arenadata/consul/command/acl/token/clone"
	acltcreate "github.com/arenadata/consul/command/acl/token/create"
	acltdelete "github.com/arenadata/consul/command/acl/token/delete"
	acltlist "github.com/arenadata/consul/command/acl/token/list"
	acltread "github.com/arenadata/consul/command/acl/token/read"
	acltupdate "github.com/arenadata/consul/command/acl/token/update"
	"github.com/arenadata/consul/command/agent"
	"github.com/arenadata/consul/command/catalog"
	catlistdc "github.com/arenadata/consul/command/catalog/list/dc"
	catlistnodes "github.com/arenadata/consul/command/catalog/list/nodes"
	catlistsvc "github.com/arenadata/consul/command/catalog/list/services"
	"github.com/arenadata/consul/command/config"
	configdelete "github.com/arenadata/consul/command/config/delete"
	configlist "github.com/arenadata/consul/command/config/list"
	configread "github.com/arenadata/consul/command/config/read"
	configwrite "github.com/arenadata/consul/command/config/write"
	"github.com/arenadata/consul/command/connect"
	"github.com/arenadata/consul/command/connect/ca"
	caget "github.com/arenadata/consul/command/connect/ca/get"
	caset "github.com/arenadata/consul/command/connect/ca/set"
	"github.com/arenadata/consul/command/connect/envoy"
	pipebootstrap "github.com/arenadata/consul/command/connect/envoy/pipe-bootstrap"
	"github.com/arenadata/consul/command/connect/expose"
	"github.com/arenadata/consul/command/connect/proxy"
	"github.com/arenadata/consul/command/connect/redirecttraffic"
	"github.com/arenadata/consul/command/debug"
	"github.com/arenadata/consul/command/event"
	"github.com/arenadata/consul/command/exec"
	"github.com/arenadata/consul/command/forceleave"
	"github.com/arenadata/consul/command/info"
	"github.com/arenadata/consul/command/intention"
	ixncheck "github.com/arenadata/consul/command/intention/check"
	ixncreate "github.com/arenadata/consul/command/intention/create"
	ixndelete "github.com/arenadata/consul/command/intention/delete"
	ixnget "github.com/arenadata/consul/command/intention/get"
	ixnlist "github.com/arenadata/consul/command/intention/list"
	ixnmatch "github.com/arenadata/consul/command/intention/match"
	"github.com/arenadata/consul/command/join"
	"github.com/arenadata/consul/command/keygen"
	"github.com/arenadata/consul/command/keyring"
	"github.com/arenadata/consul/command/kv"
	kvdel "github.com/arenadata/consul/command/kv/del"
	kvexp "github.com/arenadata/consul/command/kv/exp"
	kvget "github.com/arenadata/consul/command/kv/get"
	kvimp "github.com/arenadata/consul/command/kv/imp"
	kvput "github.com/arenadata/consul/command/kv/put"
	"github.com/arenadata/consul/command/leave"
	"github.com/arenadata/consul/command/lock"
	"github.com/arenadata/consul/command/login"
	"github.com/arenadata/consul/command/logout"
	"github.com/arenadata/consul/command/maint"
	"github.com/arenadata/consul/command/members"
	"github.com/arenadata/consul/command/monitor"
	"github.com/arenadata/consul/command/operator"
	operauto "github.com/arenadata/consul/command/operator/autopilot"
	operautoget "github.com/arenadata/consul/command/operator/autopilot/get"
	operautoset "github.com/arenadata/consul/command/operator/autopilot/set"
	operautostate "github.com/arenadata/consul/command/operator/autopilot/state"
	operraft "github.com/arenadata/consul/command/operator/raft"
	operraftlist "github.com/arenadata/consul/command/operator/raft/listpeers"
	operraftremove "github.com/arenadata/consul/command/operator/raft/removepeer"
	"github.com/arenadata/consul/command/operator/raft/transferleader"
	"github.com/arenadata/consul/command/operator/usage"
	"github.com/arenadata/consul/command/operator/usage/instances"
	"github.com/arenadata/consul/command/peering"
	peerdelete "github.com/arenadata/consul/command/peering/delete"
	peerestablish "github.com/arenadata/consul/command/peering/establish"
	peergenerate "github.com/arenadata/consul/command/peering/generate"
	peerlist "github.com/arenadata/consul/command/peering/list"
	peerread "github.com/arenadata/consul/command/peering/read"
	"github.com/arenadata/consul/command/reload"
	"github.com/arenadata/consul/command/rtt"
	"github.com/arenadata/consul/command/services"
	svcsderegister "github.com/arenadata/consul/command/services/deregister"
	svcsexport "github.com/arenadata/consul/command/services/export"
	svcsregister "github.com/arenadata/consul/command/services/register"
	"github.com/arenadata/consul/command/snapshot"
	snapinspect "github.com/arenadata/consul/command/snapshot/inspect"
	snaprestore "github.com/arenadata/consul/command/snapshot/restore"
	snapsave "github.com/arenadata/consul/command/snapshot/save"
	"github.com/arenadata/consul/command/tls"
	tlsca "github.com/arenadata/consul/command/tls/ca"
	tlscacreate "github.com/arenadata/consul/command/tls/ca/create"
	tlscert "github.com/arenadata/consul/command/tls/cert"
	tlscertcreate "github.com/arenadata/consul/command/tls/cert/create"
	"github.com/arenadata/consul/command/troubleshoot"
	troubleshootports "github.com/arenadata/consul/command/troubleshoot/ports"
	troubleshootproxy "github.com/arenadata/consul/command/troubleshoot/proxy"
	troubleshootupstreams "github.com/arenadata/consul/command/troubleshoot/upstreams"
	"github.com/arenadata/consul/command/validate"
	"github.com/arenadata/consul/command/version"
	"github.com/arenadata/consul/command/watch"
