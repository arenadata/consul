...
func TestNodeRenamingNodes(t *testing.T) {
	...
	if err := s.EnsureNode(10, in2Modify); err != nil {
		t.Fatalf("Renaming node2 into node1 should not fail: %v", err)
	}
...
func TestStateStore_ConnectQueryBlocking(t *testing.T) {
	...
	tests := []struct {
		...
		{
			// See https://github.com/shulutkov/yellow-pages/issues/5506. The issue is cause
		...
		{
			// See https://github.com/shulutkov/yellow-pages/issues/5506. This is the edge
