...
[agent/consul/rpc.go]: https://github.com/arenadata/consul/blob/main/agent/consul/rpc.go
...
- new grpc endpoints
- [Streaming](./streaming)
- [agent/structs](https://github.com/arenadata/consul/tree/main/agent/structs) - contains definitions of all the internal RPC protocol request and response structures.
...
- [agent/router](https://github.com/arenadata/consul/tree/main/agent/router)
- [agent/pool](https://github.com/arenadata/consul/tree/main/agent/pool)
