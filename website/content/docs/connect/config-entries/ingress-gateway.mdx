...
- Default: None
- Data type: List of string values. Refer to the [Consul repository](https://github.com/arenadata/consul/blob/v1.11.2/types/tls.go#L154-L169) for a list of supported ciphers.
