...
- `envoy_bootstrap_json_tpl` - Specifies a template in Go template syntax that
  ...
  template](https://github.com/arenadata/consul/blob/71d45a34601423abdfc0a64d44c6a55cf88fa2fc/command/connect/envoy/bootstrap_tpl.go#L129)
  ...
  here](https://github.com/arenadata/consul/blob/71d45a34601423abdfc0a64d44c6a55cf88fa2fc/command/connect/envoy/bootstrap_tpl.go#L5).
