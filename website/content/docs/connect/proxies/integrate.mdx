...
<Note>
 ...
 will still operate as designed, we do not recommend leveraging this feature because it is deprecated and will be removed when the long term replacement to native application integration (such as a proxyless gRPC service mesh integration) is delivered. Refer to [GH-10339](https://github.com/arenadata/consul/issues/10339) for additional information and to track progress toward one potential solution that is tracked as replacement functionality.
...
[`api` package]: https://github.com/arenadata/consul/tree/main/api
[`consul/connect/proxy/config.go`]: https://github.com/arenadata/consul/blob/v1.8.3/connect/proxy/config.go#L187
[`consul/connect/tls.go`]: https://github.com/arenadata/consul/blob/v1.8.3/connect/tls.go#L232-L237
[discovery chain]: /consul/docs/connect/l7-traffic/discovery-chain
[`usecache`]: https://github.com/arenadata/consul/blob/v1.8.3/api/api.go#L99-L102
