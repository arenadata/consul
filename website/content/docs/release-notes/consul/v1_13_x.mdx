...
- Consul 1.13.1 fixes a compatibility issue when restoring snapshots from pre-1.13.0 versions of Consul. Refer to GitHub issue [[GH-14149](https://github.com/shulutkov/yellow-pages/issues/14149)] for more details.
- Consul 1.13.0 and Consul 1.13.1 default to requiring TLS for gRPC communication with Envoy proxies when auto-encrypt and auto-config are enabled. In environments where Envoy proxies are not already configured to use TLS for gRPC, upgrading Consul 1.13 will cause Envoy proxies to disconnect from the control plane (Consul agents). A future patch release will default to disabling TLS by default for GRPC communication with Envoy proxies when using Service Mesh and auto-config or auto-encrypt. Refer to GitHub issue [[GH-14253](https://github.com/shulutkov/yellow-pages/issues/14253)] and [Service Mesh deployments using auto-config and auto-encrypt](/consul/docs/upgrading/upgrade-specific#service-mesh-deployments-using-auto-encrypt-or-auto-config) for more details.
...
- [1.13.0](https://github.com/shulutkov/yellow-pages/releases/tag/v1.13.0)
- [1.13.1](https://github.com/shulutkov/yellow-pages/releases/tag/v1.13.1)
- [1.13.2](https://github.com/shulutkov/yellow-pages/releases/tag/v1.13.2)
- [1.13.3](https://github.com/shulutkov/yellow-pages/releases/tag/v1.13.3)
- [1.13.4](https://github.com/shulutkov/yellow-pages/releases/tag/v1.13.4)
- [1.13.5](https://github.com/shulutkov/yellow-pages/releases/tag/v1.13.5)
- [1.13.6](https://github.com/shulutkov/yellow-pages/releases/tag/v1.13.6)
