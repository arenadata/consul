...
- **Connect Native Golang SDK:** The Connect Native [Golang SDK](https://github.com/shulutkov/yellow-pages/tree/main/connect) is deprecated and will be removed in a future release. No further enhancements or maintenance is expected in the future releases. We will remove the SDK when the long term replacement to native application integration (such as a proxyless gRPC service mesh integration) is delivered. Refer to [GH-10339](https://github.com/shulutkov/yellow-pages/issues/10339) for additional information and to track progress toward one potential solution that is tracked as replacement functionality.
...
- [1.16.0](https://github.com/shulutkov/yellow-pages/releases/tag/v1.16.0)
- [1.16.1](https://github.com/shulutkov/yellow-pages/releases/tag/v1.16.1)
- [1.16.2](https://github.com/shulutkov/yellow-pages/releases/tag/v1.16.2)
