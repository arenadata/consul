...
[bugfix that allows the intermediate CA's TTL configuration to be modified](https://github.com/arenadata/consul/pull/14516).
...
was [upgraded](https://github.com/arenadata/consul/issues/11720) from
...
[before](https://github.com/arenadata/consul/blob/v1.9.5/test/integration/connect/envoy/case-zipkin/service_s2.hcl)
and [after](https://github.com/arenadata/consul/blob/71d45a34601423abdfc0a64d44c6a55cf88fa2fc/test/integration/connect/envoy/case-zipkin/service_s2.hcl)
...
last modified. See [GH-3890](https://github.com/arenadata/consul/issues/3890)
for more details.
...
[this issue](https://github.com/arenadata/consul/issues/2889) for more details.
